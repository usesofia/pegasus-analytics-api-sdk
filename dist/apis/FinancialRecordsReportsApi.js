...
var FinancialRecordsReportsApi = /** @class */ (function (_super) {
     ...
     */
    FinancialRecordsReportsApi.prototype.getBankAccountsDashboardReportRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Gera relatório de contas bancárias com resumo financeiro
     */
    FinancialRecordsReportsApi.prototype.getBankAccountsDashboardReport = function () {
        return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
            var response;
            if (requestParameters === void 0) { requestParameters = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBankAccountsDashboardReportRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
 ...
 * @export
 */
exports.GetBankAccountsDashboardReportAmountTypeEnum = {
    Base: 'base',
    Final: 'final'
};
/**
 * @export
 */
exports.GetBankAccountsDashboardReportDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
