...
var FinancialRecordsReportsApi = /** @class */ (function (_super) {
     ...
     * Get aggregated   result report for financial records
     */
    FinancialRecordsReportsApi.prototype.systemGetAggregatedResultReportRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, urlPath, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
 ...
 * @export
 */
exports.SystemGetAggregatedResultReportAmountTypeEnum = {
    Base: 'base',
    Final: 'final'
};
/**
 * @export
 */
exports.SystemGetAggregatedResultReportDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
