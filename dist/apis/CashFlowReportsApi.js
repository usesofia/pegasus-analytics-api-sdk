...
var CashFlowReportsApi = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters['periodFrom'] == null) {
                            throw new runtime.RequiredError('periodFrom', 'Required parameter "periodFrom" was null or undefined when calling generateCashFlowReport().');
                        }
                        if (requestParameters['grouping'] == null) {
                            throw new runtime.RequiredError('grouping', 'Required parameter "grouping" was null or undefined when calling generateCashFlowReport().');
                        }
                        queryParameters = {};
     ...
     * Gera um relatório de fluxo de caixa
     */
    CashFlowReportsApi.prototype.generateCashFlowReport = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
