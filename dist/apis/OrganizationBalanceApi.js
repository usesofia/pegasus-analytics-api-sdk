 ...
 *
 */
var OrganizationBalanceApi = /** @class */ (function (_super) {
    __extends(OrganizationBalanceApi, _super);
    function OrganizationBalanceApi() {
    ...
    return OrganizationBalanceApi;
}(runtime.BaseAPI));
exports.OrganizationBalanceApi = OrganizationBalanceApi;
/**
 * @export
 */
