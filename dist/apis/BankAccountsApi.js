...
exports.GetBankAccountsReportDirectionEnum = exports.GetBankAccountsReportAmountTypeEnum = exports.BankAccountsApi = void 0;
...
var BankAccountsApi = /** @class */ (function (_super) {
     ...
     */
    BankAccountsApi.prototype.getBankAccountsReportRaw = function (requestParameters, initOverrides) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        urlPath = "/external/bank-accounts/report";
     ...
     * Gera relatório de contas bancárias
     */
    BankAccountsApi.prototype.getBankAccountsReport = function () {
        return __awaiter(this, arguments, void 0, function (requestParameters, initOverrides) {
            var response;
            if (requestParameters === void 0) { requestParameters = {}; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBankAccountsReportRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
 ...
 * @export
 */
exports.GetBankAccountsReportAmountTypeEnum = {
    Base: 'base',
    Final: 'final'
};
/**
 * @export
 */
exports.GetBankAccountsReportDirectionEnum = {
    In: 'IN',
    Out: 'OUT'
};
